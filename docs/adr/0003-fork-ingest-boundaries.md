...
Both are now empty strings, and their call sites guard on truthiness. This matters beyond branding:
...
- The engine (`src/inject/**`, `src/generators/**`) is **untouched** by E1. That is the point: E2
